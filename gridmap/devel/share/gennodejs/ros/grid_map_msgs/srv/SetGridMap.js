...
class SetGridMapRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetGridMapRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetGridMapRequest
    let len;
    let data = new SetGridMapRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetGridMapRequest(null);
...
class SetGridMapResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetGridMapResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetGridMapResponse
    let len;
    let data = new SetGridMapResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetGridMapResponse(null);
    return resolved;
    }
};
...
module.exports = {
  ...
  md5sum() { return '4f8e24cfd42bc1470fe765b7516ff7e5'; },
  datatype() { return 'grid_map_msgs/SetGridMap'; }
};
