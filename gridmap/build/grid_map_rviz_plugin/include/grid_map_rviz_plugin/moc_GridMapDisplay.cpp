...
#include "../../../../src/grid_map_rviz_plugin/include/grid_map_rviz_plugin/GridMapDisplay.hpp"
...
const QMetaObject grid_map_rviz_plugin::GridMapDisplay::staticMetaObject = {
    { &MessageFilterDisplayMod<grid_map_msgs::GridMap>::staticMetaObject, qt_meta_stringdata_grid_map_rviz_plugin__GridMapDisplay.data,
      qt_meta_data_grid_map_rviz_plugin__GridMapDisplay,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *grid_map_rviz_plugin::GridMapDisplay::qt_metacast(const char *_clname)
{
    ...
    return MessageFilterDisplayMod<grid_map_msgs::GridMap>::qt_metacast(_clname);
}

int grid_map_rviz_plugin::GridMapDisplay::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = MessageFilterDisplayMod<grid_map_msgs::GridMap>::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 6)
